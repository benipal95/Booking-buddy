...
public class FlightSearchTask extends AsyncTask<String, Void, String>
{
    ...
    public FlightSearchTask(Context theContext, RecyclerView theRecycler, TextView theTextView, int sortOption)
    {
        super();
        initializeTask(theContext, theRecycler, theTextView, sortOption);
    }
    ...
    protected void onPostExecute(String result)
    {
        ...
        adapter = new FlightListRecyclerView(dataJSON);
    ...
    private void initializeTask(Context theContext, RecyclerView theRecycler, TextView theTextView, int sortOption)
    {
        mContext = theContext;
